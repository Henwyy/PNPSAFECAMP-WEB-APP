...
<head>
  ...
  <title>PNP Camp Crame QR System</title>
  <base href="/">
  ...
  <style>
    body {
      background-image: url("<?= base_url() ?>/assets/img/PNPbackground.png");
            ...
            <div class="login-form-container">
              ...
              <form id="login-form">
                <div class="form-group mt-3">
                  <input type="text" class="form-control standard-form-field username login-input" id="username" name="username" placeholder="USERNAME" style="width: 350px;">
                </div>
